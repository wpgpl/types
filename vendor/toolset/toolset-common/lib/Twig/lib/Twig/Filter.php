 ...
 */
abstract class Twig_Filter implements \OTGS\Toolset\Twig_FilterInterface, \OTGS\Toolset\Twig_FilterCallableInterface
{
    protected $options;
    protected $arguments = [];
    ...
    public function getSafe(\OTGS\Toolset\Twig\Node\Node $filterArgs)
    {
