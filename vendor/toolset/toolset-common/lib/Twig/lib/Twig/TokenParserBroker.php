 ...
 */
class Twig_TokenParserBroker implements \OTGS\Toolset\Twig_TokenParserBrokerInterface
{
    protected $parser;
    protected $parsers = [];
    protected $brokers = [];
    ...
    public function __construct($parsers = [], $brokers = [], $triggerDeprecationError = \true)
    {
        ...
        foreach ($brokers as $broker) {
            if (!$broker instanceof \OTGS\Toolset\Twig_TokenParserBrokerInterface) {
    ...
    public function removeTokenParser(\OTGS\Toolset\Twig\TokenParser\TokenParserInterface $parser)
    {
        $name = $parser->getTag();
