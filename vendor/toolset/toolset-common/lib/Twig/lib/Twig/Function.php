 ...
 */
abstract class Twig_Function implements \OTGS\Toolset\Twig_FunctionInterface, \OTGS\Toolset\Twig_FunctionCallableInterface
{
    protected $options;
    protected $arguments = [];
    ...
    public function getSafe(\OTGS\Toolset\Twig\Node\Node $functionArgs)
    {
