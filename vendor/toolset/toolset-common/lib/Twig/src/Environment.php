...
use OTGS\Toolset\Twig\Cache\CacheInterface;
use OTGS\Toolset\Twig\Cache\FilesystemCache;
use OTGS\Toolset\Twig\Cache\NullCache;
...
use OTGS\Toolset\Twig\Extension\CoreExtension;
use OTGS\Toolset\Twig\Extension\EscaperExtension;
use OTGS\Toolset\Twig\Extension\ExtensionInterface;
use OTGS\Toolset\Twig\Extension\GlobalsInterface;
use OTGS\Toolset\Twig\Extension\InitRuntimeInterface;
use OTGS\Toolset\Twig\Extension\OptimizerExtension;
use OTGS\Toolset\Twig\Extension\StagingExtension;
use OTGS\Toolset\Twig\Loader\ArrayLoader;
use OTGS\Toolset\Twig\Loader\ChainLoader;
use OTGS\Toolset\Twig\Loader\LoaderInterface;
...
use OTGS\Toolset\Twig\RuntimeLoader\RuntimeLoaderInterface;
...
class Environment
{
    ...
    protected $templateClassPrefix = '\\OTGS\\Toolset\\__TwigTemplate_';
     ...
     */
    public function __construct(\OTGS\Toolset\Twig\Loader\LoaderInterface $loader = null, $options = [])
    {
        if (null !== $loader) {
        ...
        $options = \array_merge(['debug' => \false, 'charset' => 'UTF-8', 'base_template_class' => '\\OTGS\\Toolset\\Twig\\Template', 'strict_variables' => \false, 'autoescape' => 'html', 'cache' => \false, 'auto_reload' => null, 'optimizations' => -1], $options);
        ...
        $this->addExtension(new \OTGS\Toolset\Twig\Extension\CoreExtension());
        $this->addExtension(new \OTGS\Toolset\Twig\Extension\EscaperExtension($options['autoescape']));
        $this->addExtension(new \OTGS\Toolset\Twig\Extension\OptimizerExtension($options['optimizations']));
        $this->staging = new \OTGS\Toolset\Twig\Extension\StagingExtension();
        // For BC
    ...
    public function setCache($cache)
    {
        if (\is_string($cache)) {
            ...
            $this->cache = new \OTGS\Toolset\Twig\Cache\FilesystemCache($cache);
        } elseif (\false === $cache) {
            $this->originalCache = $cache;
            $this->cache = new \OTGS\Toolset\Twig\Cache\NullCache();
        } elseif (null === $cache) {
            ...
            $this->cache = new \OTGS\Toolset\Twig\Cache\NullCache();
        } elseif ($cache instanceof \OTGS\Toolset\Twig\Cache\CacheInterface) {
    ...
    {
        if ($name instanceof \OTGS\Toolset\Twig\TemplateWrapper) {
            return $name;
        }
        if ($name instanceof \OTGS\Toolset\Twig\Template) {
            return new \OTGS\Toolset\Twig\TemplateWrapper($this, $name);
        }
        return new \OTGS\Toolset\Twig\TemplateWrapper($this, $this->loadTemplate($name));
    }
    /**
        ...
        if (!\class_exists($cls, \false)) {
            ...
            if (!\class_exists($cls, \false)) {
                ...
                if (!$loader instanceof \OTGS\Toolset\Twig\Loader\SourceContextLoaderInterface) {
                    $source = new \OTGS\Toolset\Twig\Source($loader->getSource($name), $name);
                } else {
            ...
            if (!\class_exists($cls, \false)) {
                throw new \OTGS\Toolset\Twig\Error\RuntimeError(\sprintf('Failed to load Twig template "%s", index "%s": cache might be corrupted.', $name, $index), -1, $source);
            }
        }
    ...
    public function createTemplate($template, $name = null)
    {
        ...
        $loader = new \OTGS\Toolset\Twig\Loader\ChainLoader([new \OTGS\Toolset\Twig\Loader\ArrayLoader([$name => $template]), $current = $this->getLoader()]);
        $this->setLoader($loader);
        try {
            $template = new \OTGS\Toolset\Twig\TemplateWrapper($this, $this->loadTemplate($name));
        } catch (\Exception $e) {
    ...
    public function resolveTemplate($names)
    {
        ...
        throw new \OTGS\Toolset\Twig\Error\LoaderError(\sprintf('Unable to find one of the following templates: "%s".', \implode('", "', $names)));
    }
    /**
    ...
    public function getLexer()
    {
        ...
        if (null === $this->lexer) {
            $this->lexer = new \OTGS\Toolset\Twig\Lexer($this);
        }
        return $this->lexer;
    }
    public function setLexer(\OTGS\Toolset\Twig_LexerInterface $lexer)
    {
        $this->lexer = $lexer;
    }
    /**
    ...
    {
        if (!$source instanceof \OTGS\Toolset\Twig\Source) {
            ...
            $source = new \OTGS\Toolset\Twig\Source($source, $name);
        }
        if (null === $this->lexer) {
            $this->lexer = new \OTGS\Toolset\Twig\Lexer($this);
        }
    ...
    public function getParser()
    {
        @\trigger_error(\sprintf('The %s() method is deprecated since version 1.25 and will be removed in 2.0.', __FUNCTION__), \E_USER_DEPRECATED);
        if (null === $this->parser) {
            $this->parser = new \OTGS\Toolset\Twig\Parser($this);
        }
        return $this->parser;
    }
    public function setParser(\OTGS\Toolset\Twig_ParserInterface $parser)
    {
        $this->parser = $parser;
    }
    /**
    ...
    public function getCompiler()
    {
        ...
        if (null === $this->compiler) {
            $this->compiler = new \OTGS\Toolset\Twig\Compiler($this);
        }
        return $this->compiler;
    }
    public function setCompiler(\OTGS\Toolset\Twig_CompilerInterface $compiler)
    {
     ...
     */
    public function compile(\OTGS\Toolset\Twig_NodeInterface $node)
    {
        if (null === $this->compiler) {
            $this->compiler = new \OTGS\Toolset\Twig\Compiler($this);
        }
    ...
    public function compileSource($source, $name = null)
    {
        ...
        try {
            ...
            throw new \OTGS\Toolset\Twig\Error\SyntaxError(\sprintf('An exception has been thrown during the compilation of a template ("%s").', $e->getMessage()), -1, $source, $e);
        }
    }
    public function setLoader(\OTGS\Toolset\Twig\Loader\LoaderInterface $loader)
    {
        if (!$loader instanceof \OTGS\Toolset\Twig\Loader\SourceContextLoaderInterface && 0 !== \strpos(\get_class($loader), 'Mock_')) {
     ...
     */
    public function addRuntimeLoader(\OTGS\Toolset\Twig\RuntimeLoader\RuntimeLoaderInterface $loader)
    {
    ...
    public function getExtension($class)
    {
        ...
        if (!isset($this->extensionsByClass[$class])) {
            throw new \OTGS\Toolset\Twig\Error\RuntimeError(\sprintf('The "%s" extension is not enabled.', $class));
        }
    ...
    public function getRuntime($class)
    {
        ...
        throw new \OTGS\Toolset\Twig\Error\RuntimeError(\sprintf('Unable to load the "%s" runtime.', $class));
    }
    public function addExtension(\OTGS\Toolset\Twig\Extension\ExtensionInterface $extension)
    {
    ...
    public function getTags()
    {
        ...
        foreach ($this->getTokenParsers()->getParsers() as $parser) {
            if ($parser instanceof \OTGS\Toolset\Twig\TokenParser\TokenParserInterface) {
    ...
    {
        if (!$name instanceof \OTGS\Toolset\Twig\TwigFilter && !($filter instanceof \OTGS\Toolset\Twig\TwigFilter || $filter instanceof \OTGS\Toolset\Twig_FilterInterface)) {
            throw new \LogicException('A filter must be an instance of \\Twig_FilterInterface or \\Twig_SimpleFilter.');
        }
        if ($name instanceof \OTGS\Toolset\Twig\TwigFilter) {
            $filter = $name;
            $name = $filter->getName();
        } else {
    ...
    {
        if (!$name instanceof \OTGS\Toolset\Twig\TwigTest && !($test instanceof \OTGS\Toolset\Twig\TwigTest || $test instanceof \OTGS\Toolset\Twig_TestInterface)) {
            throw new \LogicException('A test must be an instance of \\Twig_TestInterface or \\Twig_SimpleTest.');
        }
        if ($name instanceof \OTGS\Toolset\Twig\TwigTest) {
            $test = $name;
            $name = $test->getName();
        } else {
    ...
    {
        if (!$name instanceof \OTGS\Toolset\Twig\TwigFunction && !($function instanceof \OTGS\Toolset\Twig\TwigFunction || $function instanceof \OTGS\Toolset\Twig_FunctionInterface)) {
            throw new \LogicException('A function must be an instance of \\Twig_FunctionInterface or \\Twig_SimpleFunction.');
        }
        if ($name instanceof \OTGS\Toolset\Twig\TwigFunction) {
            $function = $name;
    ...
    public function computeAlternatives($name, $items)
    {
        ...
        return \OTGS\Toolset\Twig\Error\SyntaxError::computeAlternatives($name, $items);
    }
    /**
     * @internal
     */
    ...
    protected function initExtensions()
    {
        ...
        $this->parsers = new \OTGS\Toolset\Twig_TokenParserBroker([], [], \false);
        $this->filters = [];
        $this->functions = [];
        $this->tests = [];
        $this->visitors = [];
     ...
     * @internal
     */
    protected function initExtension(\OTGS\Toolset\Twig\Extension\ExtensionInterface $extension)
    {
        // filters
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            ...
            } elseif ($parser instanceof \OTGS\Toolset\Twig_TokenParserBrokerInterface) {
    ...
    {
        $hashParts = \array_merge(\array_keys($this->extensions), [(int) \function_exists('OTGS\\Toolset\\twig_template_get_attributes'), \PHP_MAJOR_VERSION, \PHP_MINOR_VERSION, self::VERSION, (int) $this->debug, $this->baseTemplateClass, (int) $this->strictVariables]);
        $this->optionsHash = \implode(':', $hashParts);
    }
}
\class_alias('OTGS\\Toolset\\Twig\\Environment', 'OTGS\\Toolset\\Twig_Environment');
