...
class Types_Shortcode_Generator extends Toolset_Shortcode_Generator {
	...
	private function maybe_register_repeating_meta_dialog_groups( $repeatable_field_groups, $domain ) {
		...
		/*
		 * The following code chunk was commented out in order to allow repeating meta to be shown in the
		 * "Fields and Views" dialog of the "TB Fields and Text" block. There is no way, at the point the
		 * Shortcodes GUI is loaded, to know that the repeating meta will be needed, so they are added everywhere.
		 *
		 * This might trigger usability questions and maybe we could find a way in the future to better handle this,
		 * so this is why the code stays here commented out.
		 */
